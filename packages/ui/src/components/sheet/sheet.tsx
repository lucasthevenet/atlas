...
const sheetVariants = cva(
  "fixed z-50 scale-100 gap-4 bg-white dark:bg-gray-950 p-6 opacity-100 shadow-lg border border-gray-200 dark:border-gray-800",
  {
    variants: {
      position: {
